...
printf "  ${LIGHT_BLUE}%-7s${BOLD_WHITE}%-25s ${LIGHT_BLUE}%-7s${BOLD_WHITE}%-25s${NC}\n" "OS:" "$os_info" "ISP:" "$isp_info"
...
echo -e "silakan hubungi admin https://wa.me/6282120514304 \n"
...
echo -e "${YELLOW}┌───────────// ${CYAN}MACRO TUNNELING ID${YELLOW} //─────────────┐${NC}"
_draw_info_panel
...
wget -O /root/zi.sh https://raw.githubusercontent.com/Supremo198/my/main/zi.sh
...
wget -O /usr/local/bin/zivpn_helper.sh https://raw.githubusercontent.com/Supremo198/my/main/zivpn_helper.sh
if [ $? -ne 0 ]; then
...
LICENSE_URL="https://raw.githubusercontent.com/Supremo/mt/main/ip"
LICENSE_INFO_FILE="/etc/zivpn/.license_info"
